...
class TextEncoder(nn.Module):
    ...
    def __init__(self, input_size=768, out_size=300, rnn=False, rnn_type='LSTM', ch=False, finetune=True):
        ...
        if self.ch:
            ...
            self.bert_model = BertModel.from_pretrained('bert/bert-base-uncased')
    ...
    def forward(self, texts, word_seq, word_length):
        ...
        texts = pad_sequence(captions, batch_first=True)
        if self.rnn:
...
class ImageEncoder(nn.Module):
    ...
    # def __init__(self, input_dim=512, inter_dim=500, output_dim=300):
        """
        ...
        self.fc1 = nn.Linear(512, self.inter_dim)
